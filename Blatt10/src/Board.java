...
public class Board {
    ...
    /*
    Wir ändern ausschließlich den aktuellen Roboter und auch das Array der Roboter,
    da sich deren Positionen ändern, alles andere bleibt unverändert
    */
    @Override
    public boolean equals(Object o) {
        ...
        Board board = (Board) o;
        return targetRobot == board.targetRobot && Arrays.equals(robots, board.robots);
    }

    @Override
    public int hashCode() {
        /* TODO */
        int result = Arrays.hashCode(robots);
        result = 31 * result + targetRobot;
        return result;
    }
