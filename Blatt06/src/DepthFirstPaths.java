...
public class DepthFirstPaths {
    ...
    private void dfs(Graph G, int v) {
        ...
        /*
        Zuerst fügen wir unseren Knote zur Warteschlange(preorder) hinzu, von der aus wir die Tiefensuche durchführen werden.
        Als nächstes suchen wir nach verbundenen Knoten für diesen Knoten und legen den Abstand für sie sowie
        den Scheitelpunkt fest, der der übergeordnete Knoten ist.
        Und wir verwenden Rekursion für einen wiederholten Durchgang
         */
        preorder.add(v);
        marked[v] = true;
        for (int w : G.adj(v)) {
    ...
    /*
    Hier ist das Prinzip hauptsächlich dasselbe, aber jetzt haben wir keine Rekursion und verwenden stattdessen Stack
     */
